...
const services = [
  {
    ...
    slug: "/services/full-stack-web-development",
  ...
  {
    title: "Mobile Apps",
    slug: "/services/mobile-applications",
  ...
  {
    title: "AI & ML",
    slug: "/services/ai-ml-integration",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <RevealContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" amount={0.1}>
          {services.map((service, index) => (
            ...
            >
              <div className="group relative h-full bg-white rounded-3xl p-8 border border-slate-200 transition-all duration-300 hover:border-blue-500 hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-2 cursor-pointer">
