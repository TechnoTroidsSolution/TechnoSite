      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
            ...
            <Link href="/" className="shrink-0">
              <div className="flex items-center group">
                <div
                  ...
                  className="w-12 h-12 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105"
                >
                  <svg
                    className="w-7 h-7 text-white"
                    fill="none"
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Link
              href="/contact"
              // Updated Gradient and Hover Colors
              className="ml-4 bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white px-6 py-2.5 rounded-lg font-semibold transition-all duration-300 shadow-md hover:shadow-xl hover:scale-105 flex items-center gap-2"
            >
              Get Started
              <svg
                className="w-4 h-4"
          ...
          <div className="md:hidden flex items-center space-x-2">
            <button
              onClick={() => setIsMenuOpen(!isMenuOpen)}
              // Updated Mobile Button Colors
              className="inline-flex items-center justify-center p-2.5 rounded-lg text-gray-700 hover:text-blue-600 hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200"
              aria-expanded="false"
            >
              <span className="sr-only">Open main menu</span>
              {!isMenuOpen ? (
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-4 space-y-1 bg-white/95 backdrop-blur-sm border-t border-gray-100 rounded-b-xl shadow-lg">
              ...
              <Link
                href="/contact"
                // Updated Mobile CTA Gradient
                className="block w-full text-center bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white px-4 py-3 rounded-lg font-semibold transition-all duration-300 mt-4 shadow-md hover:shadow-lg"
                onClick={() => setIsMenuOpen(false)}
              >
                Get Started →
              </Link>
