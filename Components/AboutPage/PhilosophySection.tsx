...
export default function PhilosophySection({
  ...
  desc: 'Building protected, dependable systems with advanced encryption, smart authentication, and proactive monitoring — so you can focus on growth with confidence.',
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
