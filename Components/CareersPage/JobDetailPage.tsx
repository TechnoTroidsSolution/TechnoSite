...
const JobDetailPage = ({ job }: { readonly job: Job | undefined }) => {
  ...
  const handleShareFacebook = () => {
    shareOnFacebook(getCurrentUrl());
  };

  const handleShareTwitter = () => {
    shareOnTwitter(getCurrentUrl(), job.title);
  };

  const handleShareLinkedIn = () => {
    shareOnLinkedIn(getCurrentUrl());
  };
          ...
          <div className="lg:col-span-1">
            <div className="space-y-6 sticky top-20">
              ...
              <div className="bg-gradient-to-br from-[var(--primary)] to-[var(--accent)] rounded-2xl p-6 text-white shadow-lg">
                ...
                <button 
                  onClick={() => setIsApplicationFormOpen(true)}
                  className="w-full bg-white text-[var(--primary)] px-6 py-3 rounded-lg font-semibold hover:bg-gray-50 transition-colors cursor-pointer">
                  Apply Now
                </button>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className="flex-1 p-2 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer"
                  ...
                  <button 
                    ...
                    className="flex-1 p-2 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer relative"
                ...
                {showCopiedToast && (
                  <div className="mt-3 bg-green-50 border border-green-200 text-green-800 px-3 py-2 rounded-lg text-sm text-center animate-fade-in">
