  ...
  return (
    <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 border border-gray-100">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="lg:w-2/5 bg-linear-to-br from-teal-50 to-white border-2 border-teal-300 rounded-xl p-6 relative shadow-md hover:shadow-lg transition-shadow duration-300">
                <span className="absolute -top-3 left-6 bg-teal-500 text-white text-xs font-bold py-1.5 px-4 rounded-full shadow-md uppercase">
                  I&apos;m New Here
                </span>
                <div className="flex flex-col items-start text-left space-y-3 mt-1">
                  ...
                  <a href="mailto:sales@techno.com" className="text-teal-600 hover:text-teal-700 font-semibold text-sm hover:underline transition-colors duration-200">
                    sales@techno.com
                  </a>
                </div>
              </div>
              ...
              <div className="lg:w-3/5 bg-white border-2 border-gray-300 rounded-xl p-6 relative shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-1">
                  {/* Card 1 */}
                  <div className="flex flex-col p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-teal-400 transition-colors duration-200">
                    ...
                    <p className="text-xs leading-snug mb-2 text-gray-700 grow">
                      Need help with adding licenses, changing plans, or additional services?
                    </p>
                    <a href="mailto:upgrade@techno.com" className="text-teal-600 hover:text-teal-700 font-semibold text-xs hover:underline transition-colors duration-200">
                      upgrade@techno.com
                    </a>
                  </div>
                  ...
                  <div className="flex flex-col p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-teal-400 transition-colors duration-200">
                    ...
                    <a href="mailto:renewal@techno.com" className="text-teal-600 hover:text-teal-700 font-semibold text-xs hover:underline transition-colors duration-200">
                      renewal@techno.com
                    </a>
                  </div>
                  ...
                  <div className="flex flex-col p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-teal-400 transition-colors duration-200">
                    ...
                    <a href="mailto:cancellation@techno.com" className="text-teal-600 hover:text-teal-700 font-semibold text-xs hover:underline transition-colors duration-200">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <button className="bg-teal-500 hover:bg-teal-600 text-white font-semibold py-3 px-6 rounded-lg transition duration-200 inline-flex items-center">
                GET STARTED
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-white">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-teal-500 hover:bg-teal-600 text-white font-semibold py-3 px-6 rounded-lg transition duration-200 inline-flex items-center justify-center"
                >
                  Send Message
                  <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            ...
            {/* Book a Consultation */}
            <div className="bg-linear-to-br from-teal-500 to-teal-600 rounded-lg p-8 text-white relative overflow-hidden">
              {/* Decorative Icons */}
              ...
              <div className="relative z-10">
                ...
                <button className="bg-white text-teal-600 hover:bg-gray-100 font-semibold py-3 px-6 rounded-lg transition duration-200 w-full md:w-auto">
                  {project_inquiry.cta}
                </button>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* 24/7 Support */}
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-teal-500">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">24/7 Live Support</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-blue-500">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">Knowledge Base</h3>
              <p className="text-gray-600 text-center mb-4 text-sm">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-shadow duration-300 border-t-4 border-purple-500">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">Community Forum</h3>
              <p className="text-gray-600 text-center mb-4 text-sm">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Choose Your Preferred Channel</h2>
            <p className="text-gray-600">Compare response times and best use cases</p>
          </div>

          <div className="overflow-x-auto">
            <table className="w-full bg-white rounded-xl shadow-lg overflow-hidden">
              <thead className="bg-linear-to-r from-teal-500 to-teal-600 text-white">
                <tr>
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-teal-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-gray-600">Urgent issues, complex problems</td>
                ...
                <tr className="hover:bg-teal-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-gray-600">Quick questions, general inquiries</td>
                  <td className="px-6 py-4 text-gray-600">24/7</td>
                </tr>
                <tr className="hover:bg-teal-50 transition-colors">
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-gray-600">Detailed inquiries, documentation</td>
                  <td className="px-6 py-4 text-gray-600">24/7</td>
                </tr>
                <tr className="hover:bg-teal-50 transition-colors">
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-gray-600">Project inquiries, partnerships</td>
                  <td className="px-6 py-4 text-gray-600">24/7</td>
                </tr>
              </tbody>
            </table>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            ...
            >
              <svg className="w-6 h-6 text-gray-900 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="font-semibold text-gray-700 group-hover:text-white transition-colors">GitHub</span>
            </a>
            ...
            >
              ...
              <span className="font-semibold text-gray-700 group-hover:text-white transition-colors">YouTube</span>
            </a>
          </div>

          <div className="bg-linear-to-r from-teal-600 to-cyan-500 rounded-2xl p-10 text-center text-white shadow-2xl">
            ...
            <form className="max-w-lg mx-auto flex flex-col sm:flex-row gap-3" onSubmit={handleSubmit}>
              <input 
                ...
                className="grow px-5 py-4 rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-white/50 shadow-lg bg-white/95"
              />
              <button 
                type="submit"
                className="shrink-0 bg-white text-teal-600 hover:bg-white/90 font-bold px-8 py-4 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                Subscribe
              </button>
            </form>
            ...
            <div className="bg-linear-to-br from-teal-50 to-teal-100 rounded-xl p-8 border border-teal-200">
              ...
              <ul className="space-y-3 mt-6">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-gray-700">256-bit SSL encryption on all communications</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-teal-600 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-gray-700">GDPR & CCPA compliant data handling</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-teal-600 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <div className="bg-linear-to-br from-blue-50 to-blue-100 rounded-xl p-8 border border-blue-200">
              ...
              <ul className="space-y-3 mt-6">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-gray-700">Multi-factor authentication available</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-gray-700">24/7 security monitoring and threat detection</span>
                </li>
              </ul>
            </div>
          </div>
